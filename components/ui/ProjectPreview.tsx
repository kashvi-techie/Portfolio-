...
export function ProjectPreview({
  ...
  return (
    <motion.div
      className={`relative aspect-[16/10] w-full overflow-hidden rounded-2xl border border-[#c9a227]/15 bg-[#0a0612] ${accent}`}
      ...
      {variant === "dashboard" ? (
        <div className="relative flex h-full flex-col p-4 sm:p-6">
          <div className="mb-4 flex items-center gap-2">
            <div className="h-2 w-2 rounded-full bg-[#c9a227]/80" />
            <div className="h-2 w-2 rounded-full bg-violet-500/60" />
            <div className="h-2 w-2 rounded-full bg-white/20" />
            <span className="ml-auto text-[10px] font-medium uppercase tracking-widest text-[#c9a227]/70">
              Live preview
            </span>
          </div>
          <div className="grid flex-1 grid-cols-3 gap-2 sm:gap-3">
            <div className="col-span-2 rounded-lg border border-white/5 bg-white/[0.03] p-3">
              <div className="h-2 w-16 rounded bg-[#c9a227]/30" />
            ...
            <div className="space-y-2">
              <div className="h-full min-h-[60px] rounded-lg border border-[#c9a227]/10 bg-[#c9a227]/5" />
        ...
        <div className="relative flex h-full flex-col justify-end p-5">
          <p className="font-editorial text-xl font-semibold text-[#f5f0e6]/90 sm:text-2xl">
            {title}
          </p>
          <div className="mt-3 flex gap-2">
            <div className="h-1.5 flex-1 rounded-full bg-[#c9a227]/25" />
